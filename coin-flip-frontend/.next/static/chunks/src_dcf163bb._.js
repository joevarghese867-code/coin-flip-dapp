...
function useCoinFlipProgram() {
    ...
    const [globalGameState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useCoinFlipProgram.useMemo": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PublicKey"].findProgramAddressSync([
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from('global_gamestate')
            ], programId)
    }["useCoinFlipProgram.useMemo"], [
        programId
    ]);
    ...
    const globalGameStateQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'coin_flip',
            'global_gamestate',
            {
        ...
        queryFn: {
            "useCoinFlipProgram.useQuery[globalGameStateQuery]": async ()=>{
                try {
        ...
        }["useCoinFlipProgram.useQuery[globalGameStateQuery]"]
    });
...
_s(useCoinFlipProgram, "I199Z4z+zwFV/23EK8pZSna5DAo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$wallet$2d$adapter$2d$react$2f$lib$2f$esm$2f$useConnection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useConnection"],
...
function useCoinFlipProgramAccount(param) {
    let { user, gameNumber } = param;
    var _globalGameStateQuery_data, _globalGameStateQuery_data1;
    _s1();
    const { connection } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$wallet$2d$adapter$2d$react$2f$lib$2f$esm$2f$useConnection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useConnection"])();
    const { cluster } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cluster$2f$cluster$2d$data$2d$access$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCluster"])();
    const transactionToast = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$use$2d$transaction$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransactionToast"])();
    ...
    const currentGameNumber = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useCoinFlipProgramAccount.useMemo[currentGameNumber]": ()=>{
            var _globalGameStateQuery_data_totalGames, _globalGameStateQuery_data;
            return gameNumber !== undefined ? gameNumber : ((_globalGameStateQuery_data = globalGameStateQuery.data) === null || _globalGameStateQuery_data === void 0 ? void 0 : (_globalGameStateQuery_data_totalGames = _globalGameStateQuery_data.totalGames) === null || _globalGameStateQuery_data_totalGames === void 0 ? void 0 : _globalGameStateQuery_data_totalGames.toNumber()) || 0;
        }
    }["useCoinFlipProgramAccount.useMemo[currentGameNumber]"], [
        gameNumber,
        (_globalGameStateQuery_data = globalGameStateQuery.data) === null || _globalGameStateQuery_data === void 0 ? void 0 : _globalGameStateQuery_data.totalGames
    ]);
    const [betAccount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useCoinFlipProgramAccount.useMemo": ()=>{
            var _globalGameStateQuery_data_totalGames, _globalGameStateQuery_data;
            const gameNumber = ((_globalGameStateQuery_data = globalGameStateQuery.data) === null || _globalGameStateQuery_data === void 0 ? void 0 : (_globalGameStateQuery_data_totalGames = _globalGameStateQuery_data.totalGames) === null || _globalGameStateQuery_data_totalGames === void 0 ? void 0 : _globalGameStateQuery_data_totalGames.toNumber()) || 0;
        ...
        user,
        (_globalGameStateQuery_data1 = globalGameStateQuery.data) === null || _globalGameStateQuery_data1 === void 0 ? void 0 : _globalGameStateQuery_data1.totalGames,
        program
    ]);
...
_s1(useCoinFlipProgramAccount, "mRiQAWJwf6xYVJLIBr7WBCm2CXI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$wallet$2d$adapter$2d$react$2f$lib$2f$esm$2f$useConnection$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useConnection"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$cluster$2f$cluster$2d$data$2d$access$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCluster"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$use$2d$transaction$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransactionToast"],
...
_s(WalletButton, "LrrVfNW3d1raFE0BNzCTILYmIfo=");
_c = WalletButton;
var _c;
...
function Header() {
    ...
    const { globalGameStateQuery } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$coin$2d$flip$2f$coin$2d$flip$2d$data$2d$access$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCoinFlipProgram"])();
    const [isMenuOpen, setIsMenuOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Check if connected wallet is the global game authority
    const isAuthority = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Header.useMemo[isAuthority]": ()=>{
    ...
    const handleAdminAccess = ()=>{
        ...
        if (!globalGameStateQuery.data) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Game state not found. The game may not be initialized yet.');
            return;
        }
        if (!isAuthority) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Access denied. Only the game authority can access admin panel.');
            return;
        }
        router.push('/admin');
    };
...
_s(Header, "O05SEwPpoI5iVL3s6Udbuk4jsCU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$wallet$2d$adapter$2d$react$2f$lib$2f$esm$2f$useWallet$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWallet"],
...
function AppWalletProvider(param) {
    ...
    const endpoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AppWalletProvider.useMemo[endpoint]": ()=>'https://api.devnet.solana.com'
...
//# sourceMappingURL=src_dcf163bb._.js.map