...
function useCoinFlipProgramAccount({ user, owner, gameNumber }) {
    ...
    const place_bet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationKey: [
            'bet_account',
            'place_bet',
            {
        ...
        mutationFn: async ({ amount, choice })=>{
            ...
            return await program.methods.place_bet(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bn$2e$js$2f$lib$2f$bn$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"](amount), choice).accounts({
                user,
                owner,
                gameState,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2cf81397._.js.map